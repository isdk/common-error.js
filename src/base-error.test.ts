...
import { AbortError, AlreadyExistsError, BaseError, CommonError, ErrorCode, NotFoundError, NotImplementationError, createError, throwError } from "./base-error"
...
describe('BaseError', () => {
  ...
  it('should create BaseError via create', ()=>{
